...
interface ContactFieldsProps {
	...
	readonly invalidAutoFocus: boolean;
...
export function ContactFields({ copy, fieldsetLegend, values, errors, refs, invalidAutoFocus, onUpdate }: ContactFieldsProps) {
	return (
		<fieldset className="site-v1-contact-form__base-fields">
			...
			<div className="site-v1-contact-field site-v1-contact-field--email" data-contact-field="workEmail">
				...
				<input
					...
					maxLength={254}
					required
					autoFocus={invalidAutoFocus && Boolean(errors.workEmail)}
